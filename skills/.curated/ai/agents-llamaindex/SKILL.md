...
description: LlamaIndex framework for data-centric LLM apps and RAG. Use for document ingestion, indexing, querying, and building retrieval-driven chatbots or knowledge tools.
---
