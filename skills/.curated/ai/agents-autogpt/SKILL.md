---
name: agents-autogpt
description: AutoGPT platform for building, deploying, and running continuous autonomous agents. Use for visual workflow agents, persistent automation, and multi-step AI systems.
---
